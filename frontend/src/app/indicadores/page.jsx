    ...
    <div className="flex h-screen flex-col overflow-hidden bg-background text-foreground">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-10">
          ...
          <div className="rounded-2xl w-full md:w-7xl transition-all hover:scale-103 bg-white dark:bg-[#0C1D2C] justify-self-center shadow-md mt-10 p-6 flex justify-around animate-fade-in-up delay-100">
          ...
          <div className="flex w-full md:w-7xl transition-all hover:scale-103 justify-self-center flex-col rounded-2xl shadow-md mt-10 bg-white dark:bg-[#0C1D2C] text-center animate-fade-in-up delay-200">

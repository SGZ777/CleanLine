      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-10">
          <h1 className="font-inter text-2xl md:text-3xl md:ms-35 animate-fade-in-up delay-50">
           ...
           <div className="flex w-full max-w-7xl transition-all hover:scale-[1.01] justify-self-center flex-col rounded-2xl shadow-md mt-10 bg-white dark:bg-[#0C1D2C] animate-fade-in-up delay-200 overflow-hidden dark:border">

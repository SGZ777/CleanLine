...
const SLIDES = [
  ...
  },
  {
    ...
    subtitle: "Entenda o que cada área do sistema faz",
    description:
      "O CleanLine centraliza a visão geral do 5S, os cadastros operacionais e o acompanhamento dos indicadores para facilitar a gestão da rotina.",
    items: [
      {
        title: "Visão Geral",
        text: "Na tela inicial você acompanha as informações gerais do sistema, como pontuação média, maior nota diária, gráfico de desempenho e ranking dos setores. Essa é a área ideal para ter uma leitura rápida da situação atual antes de entrar nos demais módulos.",
        image: "/tutorial/step1.png",
        imageAlt: "Tela inicial do CleanLine com os indicadores gerais e resumo do desempenho dos setores",
      },
      {
        title: "Funcionários e Setores",
        text: "Em Funcionários você consulta, busca e adiciona colaboradores. Em Setores, organiza as áreas da empresa, com informações como nome, tag NFC, equipe vinculada e rotas relacionadas.",
        image: "/tutorial/step2.png",
        imageAlt: "Áreas de cadastro e consulta de funcionários e setores no sistema",
      },
      {
        title: "Equipes, Rotas e Checklists",
        text: "Os módulos de Equipes e Rotas ajudam a estruturar a operação e distribuir os setores. Já em Gestão de Checklists você registra, consulta e acompanha os checklists usados na rotina de avaliação e organização.",
        image: "/tutorial/step3.png",
        imageAlt: "Módulos de equipes, rotas e gestão de checklists do CleanLine",
      },
      {
        title: "Painel de Indicadores",
        text: "No Painel de Indicadores você visualiza análises mais detalhadas, como médias por setor no último trimestre e gráficos comparativos. Use essa área para acompanhar resultados, identificar tendências e apoiar decisões.",
        image: "/tutorial/step4.png",
        imageAlt: "Painel de indicadores do CleanLine com gráficos e análises dos setores",
      },
    ],
    button: "Próximo",
  },
